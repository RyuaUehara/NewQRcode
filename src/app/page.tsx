...
export default function Home() {
  ...
  return (
    <div className='w-screen flex flex-col min-h-screen items-center'>
      ...
      {/* Footer */}
      <footer className='sticky bottom-0 left-0 z-20 w-full p-4 bg-gray-300 border-t shadow md:flex md:items-center md:justify-between md:p-6 dark:bg-gray-300 dark:border-gray-600'>
